...
const RiskDashboard = Loadable(lazy(() => import('../views/pages/risks/RiskDashboard')));
...
const NewRisk = Loadable(lazy(() => import('../views/pages/risks/NewRisk')));
const DIVRiskList = Loadable(lazy(() => import('../views/pages/risks/DIVRiskList')));
